...
essencial para dominios de alta especificidad semántica como la violencia de
...
Se identifican tres líneas prioritarias. \textbf{Active Learning}:
incorporar retroalimentación del analista para reentrenar el clasificador
de forma incremental; \textbf{Reentrenamiento en GPU}: el fine-tuning
...
más eficiente y robusto; y (3)~\textbf{Modelos NER}: evaluar el uso de modelos
NER especializados para la extracción de entidades relevantes (personas,
instituciones, lugares), lo que evitaria depender de gemini para la extraccion de entidades.
