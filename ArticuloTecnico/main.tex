...
compuesta por tres módulos principales: (1)~un recolector multi-fuentes
con emulación de firma TLS/JA3 para evadir contramedidas perimetrales en 45~fuentes
RSS y Google News; (2)~un clasificador neuro-simbólico escalonado de cuatro capas que
combina el modelo Transformer \BETO{} con ajuste fino supervisado
