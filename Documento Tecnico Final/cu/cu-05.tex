...
\begin{UseCase}{CU-05}{Gestión y exportación de seguimiento}{
	...
	\UCitem{Versión}{\color{Gray}
		...
		\Titem Facilitar el monitoreo continuo de los casos más críticos identificados por el sistema y proporcionar datos para su análisis mediante la exportación de datos tabulares.
	\end{Titemize}
	...
	\end{Titemize}
		...
		\Titem Interfaz de resultados de investigación y sección de ''Seguimiento de casos'' en el Dashboard.
	\end{Titemize}
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCActor] Determina que el caso requiere monitoreo a largo plazo y hace clic en el botón \IUbutton{Dar seguimiento a caso}.
