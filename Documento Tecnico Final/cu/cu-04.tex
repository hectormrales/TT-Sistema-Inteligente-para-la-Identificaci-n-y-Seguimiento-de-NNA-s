...
\begin{UseCase}{CU-04}{Identificación por Enlace Externo}{
	...
	\UCitem{Versión}{\color{Gray}
		...
		\Titem Incorporar al sistema casos relevantes descubiertos manualmente por el usuario navegando en la web, mitigando los falsos negativos del pipeline automatizado.
	\end{Titemize}
	}\UCitem{Entradas}{\begin{Titemize}
		\Titem URL externa del artículo periodístico.
	\end{Titemize}
	}\UCitem{Origen}{\begin{Titemize}
		\Titem Formulario de "Identificar Enlace Externo" en el Dashboard.
	\end{Titemize}
	...
	\end{Titemize}
		...
		\Titem Interfaz del Dashboard (Modal de resultados).
		\Titem Base de Datos.
	\end{Titemize}
	...
	\end{Titemize}
		...
		\Titem {\bf \hypertarget{CU-04.E1}{E1}}: La URL apunta a contenido no válido (Avisos de cookies, Error 403, etc) \Trayref{CU-04}{A}.
	\end{Titemize}
	}\UCitem{Tipo}{
...
%--------------------------------------
\begin{UCtrayectoria}
	\UCpaso[\UCActor] Ingresa al apartado de "Identificar Enlace Externo" en el Dashboard.
	\UCpaso[\UCActor] Pega la URL de la noticia en el campo de texto y hace clic en \IUbutton{Investigar URL}.
	...
	\UCpaso[\UCsist] Invoca el pipeline interno de \texttt{DeepInvestigator} utilizando el texto validado y el nuevo título.
