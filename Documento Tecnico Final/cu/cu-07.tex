...
\begin{UseCase}{CU-07}{Búsqueda y Filtrado de Noticias}{%
	...
	\end{Titemize}
		...
		\Titem Término de búsqueda (\texttt{q}).
	...
	\end{Titemize}
		...
		\Titem Indicador de la fuente de datos utilizada (\texttt{postgresql\_fts} o \texttt{csv\_synonyms}).
	...
	\end{Titemize}
		...
		\Titem El corpus debe haber sido procesado por al menos un ciclo del pipeline (CU-01).
	\end{Titemize}
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Valida que el parámetro \texttt{q} no esté vacío \ErrorRef{CU-07}{E1}{Query vacío}.
	...
	\UCpaso[\UCActor] Revisa los resultados y puede activar el módulo \texttt{DeepInvestigator} sobre cualquier resultado (CU-03).
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}{CU-07}{B}{No hay datos disponibles en ninguna fuente}
	...
	\UCpaso[\UCActor] Ejecuta primero el pipeline de recolección y análisis (CU-01) para generar datos.
