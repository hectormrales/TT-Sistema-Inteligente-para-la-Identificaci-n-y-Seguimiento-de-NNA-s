...
\begin{UseCase}{CU-03}{Investigación Profunda Bajo Demanda}{
	Permite al analista activar el módulo DeepInvestigator sobre una noticia clasificada como "Alta" para generar una ficha de caso estructurada mediante búsqueda web y síntesis con IA generativa (Gemini Flash).
}
	...
	\end{Titemize}
		...
		\Titem Botón "Investigar" en la tarjeta de la noticia dentro del Dashboard.
	\end{Titemize}
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCActor] Selecciona una noticia de interés y hace clic en el botón \IUbutton{Investigar}.
...
\begin{UCtrayectoriaA}{CU-03}{B}{La API de Gemini responde con un error de cuota o falla de conexión}
	...
	\UCpaso[\UCsist] Cambia el estado de la investigación a \texttt{error} indicando "Fallo en el servicio de IA".
