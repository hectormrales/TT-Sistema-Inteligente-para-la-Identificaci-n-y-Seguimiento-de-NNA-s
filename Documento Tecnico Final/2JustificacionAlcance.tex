...
\begin{description}
    ...
    \item[PostgreSQL:] Base de datos relacional que reemplaza el almacenamiento en archivos CSV, habilitando consultas complejas,
...
En concordancia con este principio, el sistema ha sido diseñado desde su concepción con una restricción deliberada
y no negociable: \textbf{no identifica ni almacena datos personales de los NNA reales}.
