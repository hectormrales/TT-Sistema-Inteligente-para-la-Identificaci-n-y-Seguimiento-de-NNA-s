...
Los casos de uso modelan las interacciones entre los actores externos y el dashboard web.
La Tabla~\ref{tab:cu_resumen} presenta el catálogo completo; los actores interactúan exclusivamente con resultados
