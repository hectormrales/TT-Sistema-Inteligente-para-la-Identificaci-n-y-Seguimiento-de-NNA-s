...
\end{axis}
\end{tikzpicture}
\caption{Distribución de duplicados eliminados por fase de la cascada de deduplicación (Total: 213 artículos, 25\% del corpus bruto).}
...
\begin{tikzpicture}
\begin{axis}[
    title={Embudo analítico de clasificación escalonada},
    xbar,
    width=0.82\textwidth,
    height=7.5cm,
    bar width=0.50cm,
...
\end{axis}
\end{tikzpicture}
\caption{Embudo analítico del sistema de clasificación escalonada: reducción del corpus desde 634 noticias únicas hasta 27 casos de alta relevancia (4.4\%).}
