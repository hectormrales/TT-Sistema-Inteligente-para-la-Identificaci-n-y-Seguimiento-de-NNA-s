...
\begin{tikzpicture}
\begin{axis}[
    title={Represetancion por fase de la clasificación escalonada},
    xbar,
    width=0.82\textwidth,
    height=7.5cm,
    bar width=0.50cm,
...
\hline
\textbf{Falsos positivos} & 60\% & $< 30\%$ & al rededor del 20\% & \checkmark \\
\hline
...
Las etiquetas visuales (clasificación Alta/Media/Baja y score semántico)
